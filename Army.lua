...
function se.onShowDialog(id, style, title, button1, button2, text)
    ...
    local textSkip = {
        ...
        ["Для разгрузки материалов отправляйтесь по красному чекпоинту и введите"] = "{73B461}[Информация] {ffffff}На карте отмечено чекпоинтом точку разгруза каргобоба."
    }
...
function se.onServerMessage(color, text)
    ...
    local messages = {
        ...
        ["Для того чтобы начать развозку оборудования введи"] = "{73B461}[Информация] {ffffff}Чтобы начать развозку введите {FFA07A}[/carm] {ffffff}или нажмите {FFA07A}2{ffffff}.",
        ["В вашем матовозе недостаточно патронов!"] = "{73B461}[Информация] {ffffff}В вашем матовозе недостаточно патронов.",
        ["Ваш матовоз уже полностью загружен, введите /carm и выберите пункт доставки!"] = "{73B461}[Информация] {ffffff}Ваш матовоз полностью загружен, введите {FFA07A}[/carm] {ffffff}или нажмите {FFA07A}2{ffffff}."
    }
